...
# define the config files (new arch paths)
keybinds_conf="$HOME/.config/hypr/sys/keybind.conf"
user_keybinds_conf="$HOME/.config/hypr/user/keybind.conf"
laptop_conf="$HOME/.config/hypr/sys/hardware/laptop.conf"
