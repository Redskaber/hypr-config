...
>
> **Hyprland Version**: 0.56.2 (tested) · **Config Form**: Lua (native, v0.55+)  
> **⚠️ Since v0.55**: hyprlang (.conf) deprecated; .lua is current form. See [07-Lua-Reference](07-Lua-Reference/README.md).

---

## 🚀 Quick Navigation

### 🆕 Lua Configuration Reference — START HERE for .lua syntax

- **[07-Lua-Reference/README.md](07-Lua-Reference/README.md)** — .lua architecture & organization
- **[07-Lua-Reference/COMPATIBILITY.md](07-Lua-Reference/COMPATIBILITY.md)** — Syntax reference (.conf ↔ .lua)
...
| ----------------------------------------------------- | ------------------------------------------------ | --------- |
| [07-Lua-Reference/README.md](07-Lua-Reference/README.md) | .lua 配置架构与组织                            | 10 min    |
| [07-Lua-Reference/COMPATIBILITY.md](07-Lua-Reference/COMPATIBILITY.md) | 语法参考（.conf ↔ .lua 对照）          | 25 min    |

**Start Here**: 了解 .lua 配置架构，从 [07-Lua-Reference/README.md](07-Lua-Reference/README.md) 开始
...
- **"Slow startup"** →  § Load Time Optimization
- **"Service not starting"** →  § Troubleshooting
