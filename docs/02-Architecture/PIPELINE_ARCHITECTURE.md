...
| **Stage 4** | Stage 0 (`$S`, `$sys`), Stage 3 (core config)               | Stage 5 (services provide runtime context)                | Running daemons (awww, waybar, swaync, hypridle)                       |
...
[00:00.012] Stage 4: Load sys/startup.conf
            → Start awww-daemon, waybar, swaync, hypridle
